    ...
    try:
        ...
        for broker in brokers:
            try:
                ...
                print(f"✅ Inserted: {broker['name']:<10} | {broker['type']:<8} | {broker['country']:<6} | ID: {broker_id}")
                inserted_count += 1
                
            except Exception as e:
                print(f"❌ Failed to insert {broker['name']} ({broker['type']}, {broker['country']}): {e}")
        ...
        if all_brokers:
            ...
            for b in all_brokers:
                print(f"{b['broker_name']:<12} {b['broker_type']:<8} {b['country']:<8} {b['broker_id']}")

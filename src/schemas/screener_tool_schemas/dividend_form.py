...
class DividendForm(BaseScreenerForm):
    category: str = "dividend"
    description: str = "Income-focused companies that return cash to shareholders."
    ...
    payout_ratio_pct_max: ScreenerFormField[float] = field(
        75,
        is_advanced_filter=False,
    )

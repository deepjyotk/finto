...
class EconomicSensitivityForm(BaseScreenerForm):
    category: str = "economic_sensitivity"
    description: str = "Classify stocks by how sensitive they are to economic cycles."
    ...
    beta_min: ScreenerFormField[float] = field(
        None,
    ...
    sensitivity_type: ScreenerFormField[str] = field(
        "defensive",
        is_advanced_filter=False,
    )

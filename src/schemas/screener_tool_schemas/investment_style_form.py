...
class InvestmentStyleForm(BaseScreenerForm):
    category: str = "investment_style"
    description: str = (
        "Classify stocks by investment style such as blue-chip, penny, momentum, "
    ...
    style: ScreenerFormField[str] = field(
        "quality",

...
class ValueForm(BaseScreenerForm):
    category: str = "value"
    description: str = "Companies trading at relatively cheap valuation multiples."
    ...
    pe_max: ScreenerFormField[float] = field(
        15,
    ...
    pb_max: ScreenerFormField[float] = field(
        3,
        is_advanced_filter=False,
    )
    ...
    debt_to_equity_max: ScreenerFormField[float] = field(100)

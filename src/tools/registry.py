...
ALL_CATEGORIES: FrozenSet[str] = frozenset(
    {
        VALUATION, PROFITABILITY, LIQUIDITY, LEVERAGE, EFFICIENCY, GROWTH,
        RISK, DIVIDEND, TECHNICAL, TRADING, PRICE_DATA, FINANCIAL_STMT,
        EARNINGS_EST, OWNERSHIP, SCREENING, PORTFOLIO_CALC,
    }
)
...
_CATEGORY_KEYWORDS: Dict[str, List[str]] = {
    VALUATION: [
        ...
        "p/s", "price to sales", "peg", "ev/ebitda", "enterprise value",
        "valuation", "overvalued", "undervalued", "fair value", "intrinsic",
    ],
    PROFITABILITY: [
        "roe", "return on equity", "roi", "return on investment", "roa",
        "return on assets", "profit margin", "ebitda margin", "operating margin",
        "net margin", "gross margin", "profitability", "dupont",
    ],
    LIQUIDITY: [
        "current ratio", "quick ratio", "cash ratio", "liquidity", "working capital",
    ],
    LEVERAGE: [
        "debt to equity", "d/e", "leverage", "interest coverage", "debt ratio",
        "equity multiplier", "financial leverage",
    ],
    EFFICIENCY: [
        "asset turnover", "inventory turnover", "receivable turnover",
        "payable turnover", "efficiency", "operating cycle", "cash conversion",
    ],
    GROWTH: [
        "cagr", "growth rate", "revenue growth", "earnings growth",
        "compound annual", "yoy", "year over year",
    ],
    RISK: [
        "sharpe", "sortino", "beta", "alpha", "volatility", "risk",
        "drawdown", "var", "value at risk", "standard deviation",
        "downside deviation", "tracking error", "information ratio",
        "treynor",
    ],
    DIVIDEND: [
        "dividend", "yield", "payout ratio", "dividend growth", "income",
    ],
    TECHNICAL: [
        "rsi", "macd", "moving average", "sma", "ema", "bollinger",
        "technical", "momentum", "stochastic", "atr", "obv",
    ],
    TRADING: [
        "win rate", "profit factor", "expectancy", "risk reward",
        "trades", "trading",
    ],
    PRICE_DATA: [
        "price", "close price", "current price", "historical price",
    ...
    EARNINGS_EST: [
        "eps", "earnings estimate", "revenue estimate", "earnings history",
        "eps trend", "eps revision", "growth estimate", "analyst",
    ],
    OWNERSHIP: [
        "institutional", "insider", "mutual fund holder", "major holder",
        "ownership", "promoter",
    ],
    SCREENING: [
        "screen", "filter", "find stocks", "top stocks", "best stocks",
        "growth stocks", "value stocks",
    ],
    PORTFOLIO_CALC: [
        "profit", "loss", "p&l", "allocation", "portfolio return",
        "holdings", "my portfolio", "my stocks",
    ],
}
